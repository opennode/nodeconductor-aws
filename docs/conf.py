...
from waldur_aws import __version__
...
htmlhelp_basename = 'waldur-awsdoc'
...
latex_documents = [
  ('index', 'waldur-aws.tex', u'Waldur AWS Documentation',
   u'OpenNode', 'manual'),
]
...
man_pages = [
    ('index', 'waldur-aws', u'Waldur AWS Documentation',
     [u'OpenNode'], 1)
]
...
texinfo_documents = [
  ('index', 'Waldur AWS', u'Waldur AWS Documentation',
   u'OpenNode', 'waldur-aws', 'One line description of project.',
   'Miscellaneous'),
]
...
Command().handle('waldur_aws', path='docs/drfapi')
